...
<div class="row">
    <div class="input-field col s4 {{ $errors->has('user_id') ? 'has-error' : '' }}">
        <select required class="select" id="user_id">
...
<div class="row">
    ...
    <div class="input-field col s6 {{ $errors->has('renavam') ? ' has-error' : '' }}">
        <input id="renavam" name="renavam" autocomplete="off" type="number" required class="validate" length="20"
...
<div class="row">
    <div class="input-field col s4 {{ $errors->has('modelo') ? ' has-error' : '' }}">
        <input id="modelo" name="modelo" autocomplete="off" type="text" required class="validate" length="8"
    ...
    <div class="input-field col s4 {{ $errors->has('marca') ? ' has-error' : '' }}">
        <input id="marca" name="marca" autocomplete="off" type="text" required class="validate" length="120"
    ...
    <div class="input-field col s4 {{ $errors->has('ano') ? ' has-error' : '' }}">
        <input id="ano" name="ano" autocomplete="off" type="text" required class="validate" length="20"
